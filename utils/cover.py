...
def ccrop():
	...
	im.crop((0,0,80,80)).resize((60,60)).save('src/img/heibai/兵.png')
	im.crop((80,0,160,80)).resize((60,60)).save('src/img/heibai/炮.png')
	im.crop((160,0,240,80)).resize((60,60)).save('src/img/heibai/馬.png')
	im.crop((240,0,320,80)).resize((60,60)).save('src/img/heibai/車.png')
	im.crop((320,0,400,80)).resize((60,60)).save('src/img/heibai/相.png')
	im.crop((400,0,480,80)).resize((60,60)).save('src/img/heibai/仕.png')
	im.crop((480,0,560,80)).resize((60,60)).save('src/img/heibai/帅.png')
	im.crop((560,0,640,80)).resize((60,60)).save('src/img/heibai/〇.png')

	im.crop((0,80,80,160)).resize((60,60)).save('src/img/heibai/卒.png')
	im.crop((80,80,160,160)).resize((60,60)).save('src/img/heibai/砲.png')
	im.crop((160,80,240,160)).resize((60,60)).save('src/img/heibai/马.png')
	im.crop((240,80,320,160)).resize((60,60)).save('src/img/heibai/车.png')
	im.crop((320,80,400,160)).resize((60,60)).save('src/img/heibai/象.png')
	im.crop((400,80,480,160)).resize((60,60)).save('src/img/heibai/士.png')
	im.crop((480,80,560,160)).resize((60,60)).save('src/img/heibai/将.png')
	im.crop((560,80,640,160)).resize((60,60)).save('src/img/heibai/〇1.png')
